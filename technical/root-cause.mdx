...
description: "kvm_mmu_get_child_sp() compared only gfn when deciding to reuse a child shadow page, ignoring role.direct. This is the root cause of Januscape (CVE-2026-53359)."
---
